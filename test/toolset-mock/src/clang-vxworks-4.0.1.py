...
if allow_properties('variant=debug', 'link=shared', 'threading=single', 'runtime-link=shared'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/libl1.so'), '-shared', input_file('bin/clang-vxworks-4.0.1/debug/lib.o'), unordered('-g', '-fPIC', '-fuse-ld=lld'))
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/test'), input_file('bin/clang-vxworks-4.0.1/debug/main.o'), input_file('bin/clang-vxworks-4.0.1/debug/libl1.so'), unordered('-g', '-fPIC', '-fuse-ld=lld'))
...
if allow_properties('variant=release', 'link=shared', 'threading=single', 'runtime-link=shared', 'strip=on'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/release/libl1.so'), '-shared', input_file('bin/clang-vxworks-4.0.1/release/lib.o'), unordered('-fPIC', '-Wl,--strip-all', '-t', '-fuse-ld=lld'))
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/release/test'), input_file('bin/clang-vxworks-4.0.1/release/main.o'), input_file('bin/clang-vxworks-4.0.1/release/libl1.so'), unordered('-fPIC', '-Wl,--strip-all', '-t', '-fuse-ld=lld'))
...
if allow_properties('variant=debug', 'link=shared', 'threading=multi', 'runtime-link=shared'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/threading-multi/libl1.so'), '-shared', input_file('bin/clang-vxworks-4.0.1/debug/threading-multi/lib.o'), unordered('-g', '-fPIC', '-fuse-ld=lld'))
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/threading-multi/test'), input_file('bin/clang-vxworks-4.0.1/debug/threading-multi/main.o'), input_file('bin/clang-vxworks-4.0.1/debug/threading-multi/libl1.so'), unordered('-g', '-fPIC', '-fuse-ld=lld'))
...
if allow_properties('variant=debug', 'link=static', 'threading=single', 'runtime-link=shared'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/link-static/test'), input_file('bin/clang-vxworks-4.0.1/debug/link-static/main.o'), input_file('bin/clang-vxworks-4.0.1/debug/link-static/libl1.a'), '-g', '-fuse-ld=lld')
...
if allow_properties('variant=debug', 'link=static', 'threading=single', 'runtime-link=static'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/link-static/runtime-link-static/test'), input_file('bin/clang-vxworks-4.0.1/debug/link-static/runtime-link-static/main.o'), input_file('bin/clang-vxworks-4.0.1/debug/link-static/runtime-link-static/libl1.a'), unordered('-g', '-fuse-ld=lld'))
...
if allow_properties('variant=debug', 'link=shared', 'threading=single', 'runtime-link=shared', 'architecture=x86', 'address-model=32'):
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/libl1.so'), '-shared', input_file('bin/clang-vxworks-4.0.1/debug/lib.o'), unordered('-g', '-march=i686', '-fPIC', '-m32', '-fuse-ld=lld'))
    ...
    command('clang++', '-o', output_file('bin/clang-vxworks-4.0.1/debug/test'), input_file('bin/clang-vxworks-4.0.1/debug/main.o'), input_file('bin/clang-vxworks-4.0.1/debug/libl1.so'), unordered('-g', '-march=i686', '-fPIC', '-m32', '-fuse-ld=lld'))
