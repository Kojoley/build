...
t.fail_test("...skipped a for lack of foo.h..." not in t.stdout())
...
t.fail_test("...skipped c for lack of foo.h..." not in t.stdout())
...
t.fail_test("...skipped a for lack of biz.h..." not in t.stdout())
